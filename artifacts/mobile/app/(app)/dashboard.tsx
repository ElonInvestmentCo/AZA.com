...
export default function DashboardScreen() {
  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1, backgroundColor: C.bg }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" contentContainerStyle={[s.scroll, { paddingBottom: insets.bottom + 48 }]}>
        ...
        {(amount || selAmt) ? (
          <Animated.View entering={FadeInUp.duration(260).springify()} style={s.summaryBox}>
            <View style={s.summaryRow}>
              ...
              <Text style={s.summaryValue}>₦{parseInt(amount || "0").toLocaleString("en-NG")}</Text>
            </View>
