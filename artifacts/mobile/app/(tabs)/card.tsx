...
const s = StyleSheet.create({
  ...
  cardBrand: { fontSize: 22, fontFamily: "Manrope_800ExtraBold", color: "#FFFFFF", letterSpacing: 2 },
  ...
  visaTxt: { fontSize: 16, fontFamily: "Manrope_800ExtraBold", color: "#FFFFFF", fontStyle: "italic", letterSpacing: 1 },
