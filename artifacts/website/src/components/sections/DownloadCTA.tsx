  ...
  return (
    <section className="py-24 bg-[#F7F8FA]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div
          className="rounded-3xl p-12 sm:p-16 relative overflow-hidden bg-white border border-gray-100"
          style={{ boxShadow: "0 4px 40px rgba(0,0,0,0.06)" }}
        >
          {/* Subtle green glow top-right */}
          <div className="absolute -top-24 -right-24 w-72 h-72 rounded-full blur-3xl pointer-events-none" style={{ background: "rgba(0,217,160,0.08)" }} />
          <div className="absolute -bottom-24 -left-24 w-72 h-72 rounded-full blur-3xl pointer-events-none" style={{ background: "rgba(59,130,246,0.05)" }} />
          ...
          <div className="relative">
            ...
            <p className="text-gray-500 text-lg mb-10 max-w-xl mx-auto leading-relaxed">
              Join 50,000+ Nigerians who manage their money smarter with PAYVORA.
              Download free today and get started in minutes.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
              <Link
                href="/download"
                className="flex items-center gap-3 px-6 py-4 bg-white rounded-2xl border border-gray-200 hover:border-gray-300 hover:shadow-md transition-all hover:-translate-y-px w-full sm:w-auto justify-center min-w-[200px]"
              >
