    ...
    <section className="py-24 bg-[#14141F]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div
          ...
          style={{
            background: "linear-gradient(135deg, #14141F 0%, #0D1F18 50%, #0A0A0F 100%)",
        ...
        >
          ...
          <div
            ...
            style={{ background: "rgba(0,217,160,0.12)" }}
          />
          <div
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
              <Link
                href="/download"
                className="flex items-center gap-3 px-6 py-4 bg-white rounded-2xl hover:bg-gray-100 transition-all hover:scale-105 w-full sm:w-auto justify-center min-w-[200px]"
              >
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-[#8F8FA3]">
              <span className="flex items-center gap-1.5">
                <Shield size={14} className="text-[#00D9A0]" /> Bank-grade security
              </span>
              <span className="flex items-center gap-1.5">
                <Zap size={14} className="text-[#00D9A0]" /> Instant settlement
              </span>
              <span className="flex items-center gap-1.5">
                <Star size={14} className="text-[#F59E0B]" fill="currentColor" /> 4.9 / 5 rating
              </span>
            </div>
          </div>
        </div>
