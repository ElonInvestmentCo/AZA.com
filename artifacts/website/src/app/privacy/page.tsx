...
const sections = [
  ...
  },
  {
    ...
    body: `We use cookies and similar tracking technologies to maintain your session, remember your preferences, and analyse how our Services are used. You may disable cookies in your browser settings, but some features may not work correctly without them. We do not use cookies for cross-site advertising.`,
  },
  {
    title: "10. International Transfers",
    body: `Your data may be processed on servers located outside Nigeria. Where we transfer data internationally, we ensure appropriate safeguards are in place, such as standard contractual clauses, to protect your information in accordance with Nigerian data protection law.`,
  },
  {
  ...
  return (
    <main className="pt-32 pb-24 bg-[#0A0A0F] min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-[#8F8FA3] mb-12">Last updated: July 6, 2026</p>

        <div className="space-y-10">
          {sections.map(({ title, body }) => (
            <section key={title}>
              <h2 className="text-xl font-bold text-white mb-4">{title}</h2>
              <div className="text-[#8F8FA3] leading-relaxed whitespace-pre-line">
                {body}
              </div>
            </section>
          ))}
        ...
        <div className="mt-16 pt-8 border-t border-[#2A2A3D]">
          <p className="text-[#8F8FA3] text-sm">
            ...
            <a href="/terms" className="text-[#00D9A0] hover:underline">Terms of Service</a>.
          </p>
        </div>
      </div>
    </main>
