import svgPaths from "./svg-itxiad06g2";
import img3DAvatars16 from "./9b19bc03f645625ddb77cba0433d55782d515d52.png";
import { imgHome } from "./svg-bfl4n";
    ...
    <div className="bg-white relative rounded-[3.15px] shrink-0 w-full" data-name="Transaction List">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[66.944px] items-center px-[12.601px] py-[6.301px] relative size-full">
          <Frame14 />
          <p className="[word-break:break-word] font-['Manrope:ExtraBold','Noto_Sans:Black','Noto_Sans_Math:Regular','Noto_Sans_Symbols:Black','Noto_Sans_Symbols2:Regular',sans-serif] font-extrabold leading-[1.5] relative shrink-0 text-[12.601px] text-[red] text-right w-[146px]">₦400,000.00</p>
        </div>
      </div>
    </div>
  );
...
function Frame7() {
  return (
    <div className="content-stretch flex flex-col font-['Roboto:Bold',sans-serif] font-bold items-start relative shrink-0 whitespace-nowrap">
      ...
      <p className="leading-[1.5] relative shrink-0 text-[#0b0a0a] text-[12.601px] text-left" style={{ fontVariationSettings: '"wdth" 100' }}>
        Summer special deal
      </p>
    </div>
  );
...
function Frame6() {
  return (
    <div className="[word-break:break-word] absolute content-stretch flex flex-col gap-[6.301px] items-start left-[12.6px] top-[12.6px]">
      <Frame7 />
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#0b0a0a] text-[9.451px] text-left w-[114.199px]" style={{ fontVariationSettings: '"wdth" 100' }}>{`Get discount for every transaction this weekend `}</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <button className="block cursor-pointer h-[97.66px] relative shrink-0 w-[263.84px]">
...
function Frame8() {
  return (
    <div className="h-[97.66px] relative shrink-0 w-[263.84px]">
      <button className="absolute bg-[#fff2cf] block cursor-pointer h-[97.66px] left-0 rounded-[3.15px] top-0 w-[263.84px]" />
      <Frame9 />
      <Group4 />
    </div>
  );
...
function WaterDrop24Outline() {
  return (
    <div className="col-1 ml-0 mt-0 overflow-clip relative row-1 size-[21px]" data-name="Water Drop / 24 / Outline">
      <div className="absolute inset-[0.28%_4.22%_-0.27%_-4.21%] overflow-clip" data-name="filter">
        <div className="absolute inset-[12.5%_16.67%]" data-name="Icon">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.9985 15.7484">
            <path clipRule="evenodd" d={svgPaths.p351d000} fill="var(--fill-0, #020202)" fillRule="evenodd" id="Icon" />
          </svg>
        </div>
      </div>
    </div>
...
function Group6() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="col-1 ml-[3.68px] mt-[3.1px] relative row-1 size-[12.601px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.6013 12.6013">
          <circle cx="6.30066" cy="6.30066" fill="var(--fill-0, #BCE2FE)" id="Ellipse 32" r="6.30066" />
        </svg>
      </div>
      <WaterDrop24Outline />
    </div>
...
function Top() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[1.575px] items-start relative shrink-0 whitespace-nowrap" data-name="Top">
...
function Greeting() {
  return (
    <div className="absolute content-stretch flex gap-[10px] items-center left-[calc(10%-17.3px)] top-[118px] w-[329px]" data-name="Greeting">
      <div className="h-[44px] relative shrink-0 w-[46px]" data-name="3D Avatars / 16">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img3DAvatars16} />
      </div>
      <Top />
      <p className="[word-break:break-word] font-['IBM_Plex_Sans:SemiBold',sans-serif] font-semibold leading-[1.2] relative shrink-0 text-[#0b0a0a] text-[18.902px] whitespace-pre" style={{ fontVariationSettings: '"wdth" 100' }}>{`         ₦200,590.00`}</p>
    </div>
  );
}
...
function BlackStatusBar() {
  return (
    <div className="absolute h-[46px] left-0 overflow-clip top-[8px] w-[388px]" data-name="Black - Status bar">
      <Group />
...
export default function UserDashBoard() {
  return (
    <div className="bg-white overflow-clip relative rounded-[20px] size-full" data-name="user dash board">
      <RecentTransaction />
      <Banner />
      ...
      <Greeting />
      <BlackStatusBar />
      <div className="absolute inset-[12.44%_5.6%_84.74%_88.3%]" data-name="Vector">
      ...
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['NIKEA:Regular',sans-serif] leading-[1.2] left-[calc(40%+39.8px)] not-italic text-[18.902px] text-black text-center top-[54px] whitespace-nowrap">aza</p>
    </div>
  );
}